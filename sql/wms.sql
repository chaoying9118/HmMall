...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`hm_wms` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
CREATE TABLE `wms_purchase_detail` (
  ...
  `stock_id` bigint(20) DEFAULT NULL COMMENT '仓库id',
...
/*Table structure for table `wms_stock_info` */

DROP TABLE IF EXISTS `wms_stock_info`;

CREATE TABLE `wms_stock_info` (
...
/*Data for the table `wms_stock_info` */

/*Table structure for table `wms_stock_order_task` */

DROP TABLE IF EXISTS `wms_stock_order_task`;

CREATE TABLE `wms_stock_order_task` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
/*Data for the table `wms_stock_order_task` */

/*Table structure for table `wms_stock_order_task_detail` */

DROP TABLE IF EXISTS `wms_stock_order_task_detail`;

CREATE TABLE `wms_stock_order_task_detail` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
/*Data for the table `wms_stock_order_task_detail` */

/*Table structure for table `wms_stock_sku` */

DROP TABLE IF EXISTS `wms_stock_sku`;

CREATE TABLE `wms_stock_sku` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `sku_id` bigint(20) DEFAULT NULL COMMENT 'sku_id',
  `stock_id` bigint(20) DEFAULT NULL COMMENT '仓库id',
...
/*Data for the table `wms_stock_sku` */
